...
public class CustomAuthenticationFilter extends AbstractCasFilter {
    ...
    protected void initInternal(final FilterConfig filterConfig) throws ServletException {
        if (!isIgnoreInitConfiguration()) {
            ...
            String casServerLoginUrlTemp = getPropertyFromInitParams(filterConfig,"casServerLoginUrl", null);
            ...
            if (StringUtils.isEmpty(casServerLoginUrlTemp)) {
                if (StringUtils.isNotEmpty(propertieFilePath)) {
                    casServerLoginUrlTemp = PropertyUtil.getValue(propertieFilePath, "sso.client.casServerLoginUrl",null);
                    ...
                    casServerLoginUrlTemp = ConfigUtil.getStringByKey("sso.client.casServerLoginUrl");
            ...
            //去除空格
            if (StringUtils.isNotEmpty(casServerLoginUrlTemp)) {
                casServerLoginUrlTemp=casServerLoginUrlTemp.trim();
            }
            ...
            if (StringUtils.isNotEmpty(casServerLoginUrlTemp)) {
                setCasServerLoginUrl(casServerLoginUrlTemp);
            } else {

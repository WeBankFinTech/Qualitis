 ...
 * @author howeye
 */
public class AddProxyUserRequest {
    ...
    public static void checkRequest(AddProxyUserRequest request) throws UnExpectedRequestException {
        if (request == null) {

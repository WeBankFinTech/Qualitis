 ...
 */
public class ModifyStandardValueRequest {
    ...
    public static void checkRequest(ModifyStandardValueRequest request)
        ...
        BeanUtils.copyProperties(request, addStandardValueRequest);
        AddStandardValueRequest.checkRequest(addStandardValueRequest);
    }

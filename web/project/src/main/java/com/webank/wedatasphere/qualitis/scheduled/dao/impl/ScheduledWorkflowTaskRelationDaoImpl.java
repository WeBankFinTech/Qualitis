...
public class ScheduledWorkflowTaskRelationDaoImpl implements ScheduledWorkflowTaskRelationDao {
    ...
    @Override
    public List<ScheduledWorkflowTaskRelation> findByScheduledWorkFlowIdAndRuleGroupId(List<Long> scheduledWorkflowIdList, List<Long> ruleGroupIdList) {
        return scheduledWorkflowTaskRelationRepository.findByScheduledWorkFlowIdAndRuleGroupId(scheduledWorkflowIdList,ruleGroupIdList);
    }
}

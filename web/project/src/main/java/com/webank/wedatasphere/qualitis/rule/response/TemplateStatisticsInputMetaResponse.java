 ...
 * @author allenzhou
 */
public class TemplateStatisticsInputMetaResponse {
    ...
    public TemplateStatisticsInputMetaResponse() {
        this.resultType = "Long";
    }

    public TemplateStatisticsInputMetaResponse(String name, String funcName, String value) {
        this.name = name;
        this.funcName = funcName;
        this.value = value;
    }

    public static void checkRequest(TemplateStatisticsInputMetaResponse request) throws UnExpectedRequestException {

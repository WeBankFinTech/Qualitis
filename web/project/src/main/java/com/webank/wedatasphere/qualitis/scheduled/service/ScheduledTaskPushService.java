...
public interface ScheduledTaskPushService {
     ...
     * @throws IOException
     */
    void uploadProject(List<WtssScheduledJobRequest> wtssScheduledJobRequests, Map<String, Object> jsonServerMap, String sessionId, String address) throws ScheduledPushFailedException, UnExpectedRequestException, IOException;
     ...
     * @throws UnExpectedRequestException
     */
    Long createIntervalWorkflow(WtssScheduledJobRequest wtssScheduledJobRequest, String sessionId, String address) throws ScheduledPushFailedException, UnExpectedRequestException;

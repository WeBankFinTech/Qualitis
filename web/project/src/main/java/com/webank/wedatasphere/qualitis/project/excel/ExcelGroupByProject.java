...
public class ExcelGroupByProject extends BaseRowModel {
    ...
    public ExcelGroupByProject() {
        // Default Constructor
    }

    public String getRuleGroupJsonObject() {
        return ruleGroupJsonObject;
    }

    public void setRuleGroupJsonObject(String ruleGroupJsonObject) {
        this.ruleGroupJsonObject = ruleGroupJsonObject;
    }
}

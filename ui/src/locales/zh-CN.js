...
export default {
    ...
    common: {
        first: '默认英文逗号分隔，多字段请使用',
        second: '包含，比如：',
        third: 'id_1,name_1',
        forth: 'id_2,name_2',
        format: '请输入，格式如：ds=',
        filter0: '可在过滤条件中添加分区变量表达式,用于指定运行时的分区。 例子：',
        filter1: '表示程序运行时的实际日期表示程序运行时的实际日期前一天，格式为',
        filter2: '，表示程序运行时的实际日期前N + 1天；若今天是20210707，填写了',
        filter3: '运行时替换为ds=\'20210704\'。',
        filter4: '，表示程序运行当日日期；若今天是 20210707，',
        filter5: '将会被替换为ds=\'20210707\'，ds=\'2021-07-07\'',
        sqlplaceholder: '在sql中请使用',
        standardName: '标准值名称',
        partitonplaceholder: '请输入顶层区分，示例 ',
        confirm: '确认',
        cancel: '取消',
        exportContent: '仅允许导出相同项目下的规则',
        copyright: 'WeDataSphere版权所有',
        moreAction: '更多操作',
        ...
        projectEnName1: '项目英文名',
        projectCnName1: '项目中文名',
        cnName: '中文名称',
        taskName: '任务名称',
        projectId: '项目Id',
        projectState: '项目状态',
        ...
        operReportingSubsManagement: '运维报表订阅管理',
        ...
        advancedFilter: '高级筛选',
        relationObject: '关联对象',
        editCollectConfig: '编辑采集配置',
        viewCollectConfig: '查看配置详情',
        editStandard: '编辑标准值',
        addStandard: '添加标准值',
        closeMoreConfig: '收起更多配置',
        openMoreConfig: '展开更多配置',
    },
    indexManagement: {
        title: '指标管理',
    ...
    myProject: {
        ...
        applicationInfoTemplate: '应用信息模版',
        executeParams: '执行参数',
        ...
        defaultAlarmLevel: '默认告警级别',
        defaultAlarmWay: '默认告警方式',
        advanceAlarmMan: '高级告警人',
        advanceAlarmLevel: '高等级告警级别',
        advanceAlarmWay: '高等级告警方式',
        ...
        lastStartTime: '最迟开始时间',
        lastFinishTime: '最迟结束时间',
        devDepartment: '开发科室',
        opsDepartment: '运维科室',
    },
    ruleQuery: {
    ...
    ruleTemplatelist: {
        ...
        templateCNFullName: '算子中文名称',
        templateENFullName: '算子英文名称',
        acquisitionLogic: '采集逻辑',
        viewDetails: '查看详情',
        templateDesc: '模板描述',
        templateFullDesc: '算子描述',
        verificationLevel: '校验级别',
        verificationType: '校验类型',
        verificationCNName: '校验值中文名',
        verificationENName: '校验值英文名',
        verificationDescription: '校验值描述',
    ...
    instanceConfig: {
        ...
        offlineSuccess: '下线成功',
        startCollectConfirm: '确认开启采集？',
        startCollectSuccess: '开启采集成功',
        stopCollectConfirm: '确认关闭采集？',
        stopCollectSuccess: '关闭采集成功',
        delete: '删除',

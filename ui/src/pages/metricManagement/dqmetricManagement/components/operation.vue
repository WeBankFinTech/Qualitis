<template>
    <div class="page-header-condition">
        ...
        <div class="condition-item">
            ...
            <FSelect v-model="formModel.en_code" filterable clearable :options="enCodes" remote @search="handleSearchEnCodes">
            </FSelect>
        </div>
        <div class="condition-item">
...
// 搜索encodes
const handleSearchEnCodes = (val) => {
    emit('on-search-encodes', val);
};
// 高级筛选

...
export function fetchEnCodes(code) {
    return FRequest('/api/v1/projector/rule_metric/en_codes', {
        page: 0,
        size: 50,
        enCode: code,
    }, 'get');
...
export function fetchProductInfo(params = {}) {
    return FRequest('/api/v1/projector/meta_data/productInfo', params);
}
// 获取业务域
export function fetchBusinessDomain(params = {}) {
    return FRequest('/api/v1/projector/meta_data/buzDomain', params, { method: 'get' });
}
// 获取监控能力
export function fetchMonitoringCapabilities(params = {}) {
    return FRequest('/api/v1/projector/metric_ext/monitoring_capabilities', params, { method: 'get' });
}
// 获取部门列表

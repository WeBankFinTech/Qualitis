...
VALUES (@dss_qualitis_appconnId,
       ...
       'Qualitis',
       'Qualitis',
       'Qualitis is a financial and one-stop data quality management platform that provides data quality model definition, visualization and monitoring of data quality results',       'Qualitis是一套金融级、一站式的数据质量管理平台，提供了数据质量模型定义，数据质量结果可视化㿁可监控等功能，并用丿整套统一的流程来定义和检测数据集的质量并及时报告问题〿',

 ...
 * @author howeye
 */
public interface TemplateDepartmentRepository extends JpaRepository<TemplateDepartment, Long> {
    /**
     * Find by template.
     * @param templateInDb
     * @return
    ...
    /**
     * Find template by department.
     * @param department
     * @return
     */
    @Query(value = "select td.template from TemplateDepartment td where td.department = ?1")

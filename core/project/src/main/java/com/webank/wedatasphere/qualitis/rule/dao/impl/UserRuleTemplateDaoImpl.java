 ...
 */
@Repository
public class UserRuleTemplateDaoImpl implements UserRuleTemplateDao {

    @Autowired
    private UserRuleTemplateRepository userRuleTemplateRepository;
    ...
    public Long countByUserId(Long userId) {
        return userRuleTemplateRepository.countByUserId(userId);
    }
}

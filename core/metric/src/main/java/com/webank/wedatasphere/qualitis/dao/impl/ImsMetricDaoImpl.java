...
import com.webank.wedatasphere.qualitis.dao.repository.ImsMetricRepository;
...
public class ImsMetricDaoImpl implements ImsMetricDao {
    ...
    @Autowired
    private ImsMetricRepository imsMetricRepository;
    ...
    @Override
    public List<ImsMetric> findByBetweenModifyTime(String startTime, String endTime) {
        return imsMetricRepository.findByBetweenModifyTime(startTime, endTime);
    }

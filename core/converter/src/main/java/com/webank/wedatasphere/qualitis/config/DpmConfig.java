...
public class DpmConfig {
    ...
    @Value("${linkis.api.meta_data.dpm_inf}")
    private String datasourceInf;
    ...
    public String getDatasourceInf() {
        return datasourceInf;
    }

    public void setDatasourceInf(String datasourceInf) {
        this.datasourceInf = datasourceInf;
    }
